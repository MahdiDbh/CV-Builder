                  ...
                  <div class="card-body" data-simplebar style="height:355px; overflow-y: auto; overflow-x: hidden;">
                    ...
                    <div class="pb-3 timeline-item item-warning">
                      <div class="pl-5">
                        ...
                        <div class="row mb-3">
                          <div class="col"><img src="{{asset('backend//assets/products/p1.jpg')}}" alt="..." class="img-fluid rounded">
                          </div>
                          <div class="col"><img src="{{asset('backend//assets/products/p2.jpg')}}" alt="..." class="img-fluid rounded">
                          </div>
                          <div class="col"><img src="{{asset('backend/assets/products/p3.jpg')}}" alt="..." class="img-fluid rounded">
                          </div>
                          <div class="col"><img src="{{asset('backend/assets/products/p4.jpg')}}" alt="..." class="img-fluid rounded">
                          </div>
                        </div>
